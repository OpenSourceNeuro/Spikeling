...
# Spikeling Emulator Page
    ...
    # Start the Emulator
    self.ui.Emulator_Connect_pushButton.clicked.connect(lambda: Graph_Emulator.EmulatorPlot(self))
...
# Imaging Page - page201
    ...
    self.ui.Imaging_GECI_comboBox.currentIndexChanged.connect(lambda: Graph_Imaging.ImagingGraph.SelectGECI(self))
